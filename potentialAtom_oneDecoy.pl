...
print "# residue1\tchnID1\tatomResNum1\tatomName1\tresidue2\tchnID2\tatomResNum2\tatomName2\tdist\tEelec\tEvdw\n";
...
while (<INPUT>) {
    ...
    if (/^\w{3}\s+/) {
        ...
        #SER	A	78	GLU	B	46	5.113

        my (
            $residue1, $chnID1,      $atomResNum1, $atomName1, $residue2,
            $chnID2,   $atomResNum2, $atomName2,   $dist
        ) = split( /\s+/, $_ );
